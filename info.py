...
PICS = (environ.get('PICS', 'https://envs.sh/vYE.jpg https://envs.sh/vYF.jpg https://envs.sh/vYd.jpg https://envs.sh/vYE.jpg https://envs.sh/vYQ.jpg https://envs.sh/vYD.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7822720438').split()]
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002457337623'))  # Notification of those who verify will be sent to your channel
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002462524420')  # Support group id (make sure bot is admin)
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('AUTH_CHANNEL', '1002457337623 -1002238603343 -1002323154734').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)

# ============================
# MongoDB Configuration
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Rahat2:uHkkglKUdaLfQFve@rahat2.06zv0.mongodb.net/?retryWrites=true&w=majority&appName=Rahat2")
...
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/ipapkorn_movies1')
OWNERID = int(os.environ.get('OWNERID', '7822720438'))  # Replace with the actual admin ID
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Movies_Rm')  # Support group link (make sure bot is admin)
